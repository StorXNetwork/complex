...
describe('Landlord', function () {
    ...
    it('will convert config instance to object', function () {
      var config = {
        ...
        opts: {
          ...
          amqpOpts: {},
          mongoUrl: 'mongodb://mongodbserver:27017/storj-test',
          mongoOpts: {},
          serverPort: 8080,
          serverOpts: {
            certficate: null,
  ...
  describe('#_bindServerRoutes', function () {
    ...
    it('will use auth and body parser', function () {
      ...
      sandbox.stub(restify.plugins, 'authorizationParser').returns('a');
      sandbox.stub(restify.plugins, 'bodyParser').returns('b');
